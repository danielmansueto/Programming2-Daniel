...
print(min(my_list)) # smallest alpabetically
...
print(customer)
print(my_list)
customer = my_list.pop(3) # pick which one you want to grap
print(customer)
print(my_list)
...
# make a 2d list that is 10 x10 [[0,1],[0,2],[0,3]]... [9,9]]
my_list = []
for i in range(10):
  for j in range(10):
    my_list.append([i,j])
...
# make a list of 1 to 100 quared, but filter out the odd numbers
my_list = []
for i in range(101):
  if i ** 2 %  2 == 0:
    my_list.append(i ** 2)
...
# roll a single die 100 times an add it to a list
my_list = []
for i in range(100):
